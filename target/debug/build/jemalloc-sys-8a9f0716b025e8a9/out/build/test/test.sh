...
for t in $@; do
  ...
  if [ -e "${t}.sh" ] ; then
    ...
    . ${t}.sh && \
    export_malloc_conf && \
    $JEMALLOC_TEST_PREFIX ${t} /Users/franky_mac/Rust_Programming/halo2-graph/target/debug/build/jemalloc-sys-8a9f0716b025e8a9/out/build/ /Users/franky_mac/Rust_Programming/halo2-graph/target/debug/build/jemalloc-sys-8a9f0716b025e8a9/out/build/
  else
    export MALLOC_CONF= && \
    export_malloc_conf && \
    $JEMALLOC_TEST_PREFIX ${t} /Users/franky_mac/Rust_Programming/halo2-graph/target/debug/build/jemalloc-sys-8a9f0716b025e8a9/out/build/ /Users/franky_mac/Rust_Programming/halo2-graph/target/debug/build/jemalloc-sys-8a9f0716b025e8a9/out/build/
